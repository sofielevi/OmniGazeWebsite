...
function getLayerDetailedFeatures(id: string): Array<{ title: string; description: string }> {
  const features: Record<string, Array<{ title: string; description: string }>> = {
    infrastructure: [
      ...
      { title: "Running Software Discovery", description: "100,000+ pieces of running software discovered" },
    ...
    applications: [
      { title: "Process Discovery", description: "Process discovery mapped to logical applications" },
    ...
    capabilities: [
      { title: "Vulnerability Detection", description: "All observations and risks aggregated to business capabilities" },
      { title: "Cost Aggregation", description: "Costs automatically aggregated to business capabilities" },
      { title: "KPIs", description: "Key performance indicators on business capabilities" },
      { title: "Compliance Frameworks", description: "ISO27001 and other compliance framework support" },
    ...
    "value-streams": [
      ...
      { title: "SSO Integration", description: "EntraId single sign-on" },
