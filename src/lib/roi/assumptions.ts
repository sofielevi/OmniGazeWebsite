...
export const assumptions: Record<string, Assumption> = {
  ...
  discoveryTimePerAsset: {
    ...
    value: 0.5,
    unit: 'hours',
    source: 'Faddom ROI Analysis',
    sourceUrl: 'https://faddom.com/whitepapers/roi/',
  ...
  auditPrepHoursPerYear: {
    ...
    value: 80,
    unit: 'hours',
    source: 'Flexera Audit Defense Study',
  ...
  auditPrepReduction: {
    ...
    value: 0.70,
    unit: '%',
    source: 'Flexera Customer Case Studies',
  ...
  dependencyMappingHoursPerWeek: {
    ...
    value: 2,
    unit: 'hours',
    source: 'Faddom Customer Surveys',
  ...
  mttrReductionWithDependencyMap: {
    ...
    value: 0.25,
    unit: '%',
    source: 'Faddom Case Studies',
    sourceUrl: 'https://faddom.com/case-studies/',
  ...
  triageTimeReductionWithContext: {
    ...
    value: 0.60,
    unit: '%',
    source: 'BiZZdesign EA ROI Study',
  ...
  complianceReductionWithAutomation: {
    ...
    value: 0.50,
    unit: '%',
    source: 'LeanIX Customer Success',
  ...
  cloudOverProvisioningPercent: {
    ...
    sourceUrl: 'https://info.flexera.com/CM-REPORT-State-of-the-Cloud',
  ...
  transformationSavingsWithEA: {
    ...
    value: 0.05,
    unit: '%',
    source: 'BiZZdesign Business Case Framework',
  ...
  eaToolConsolidationSavings: {
    ...
    value: 0.50,
    unit: '%',
    source: 'LeanIX Comparison Studies',
