...
export const pyramidLayers = [
  ...
  },
  {
    ...
    ratio: "5:1",
    color: "#8b7cf5",
    features: ["Value Stream Mapping", "Azure Cloud Discovery", "SSO"],
    tier: "Business",
  },
  {
    id: "capabilities",
    ...
    ratio: "20:1",
    color: "#9d91f8",
    features: ["FactSheets", "Capability Mapping", "OData API"],
    tier: "Professional",
  },
  {
    id: "applications",
    ...
    ratio: "5:1",
    color: "#b0a6fb",
    features: ["Process Discovery", "3D Visualization", "Scheduled Scans"],
    tier: "Starter",
  },
  {
    id: "infrastructure",
    ...
    ratio: "10:1",
    color: "#1e3a8a",
    features: ["Network Discovery", "Asset Inventory", "CMDB", "Tag Management"],
    tier: "Community",
  },
];
